...
const registration = async (req, res) => {
  ...
  if (EmailVerifycation.status == true) {
    await sendEmail(
      ...
      `<a target="_blanck" href="${PROJECT_URL}/api/auth/verify/${verifycationCode}"> verify your email - click here <a/>`
    );
  }
...
const resendVerifyEmail = async (req, res) => {
  ...
  await sendEmail(
    email,
    EmailVerifycation.title,
    `<a target="_blanck" href="${PROJECT_URL}/api/auth/verify/${user.verificationToken}"> verify your email - click here <a/>`
  );
